  ...
  return (
    <div className="flex-1 space-y-5 p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard title="Estimated Profit" value={fmt(data.estimatedProfit)} icon={<TrendingUp className="h-4 w-4" />} color={data.estimatedProfit >= 0 ? "text-green-600" : "text-red-600"} sub="Sales - GST - Purchases - Expenses" />
      </div>
      ...
      <div className="grid gap-4 mt-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <StatCard title="Total Invested" value={fmt(data.totalInvested)} icon={<Package className="h-4 w-4" />} color="text-indigo-600" sub="Capital in Stock" />
